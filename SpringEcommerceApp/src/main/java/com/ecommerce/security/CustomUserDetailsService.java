 ...
 * This service loads user-specific data and creates UserDetails object expected by Spring Security.
 * Follows Single Responsibility Principle by focusing only on user authentication details.
 */
@Service
