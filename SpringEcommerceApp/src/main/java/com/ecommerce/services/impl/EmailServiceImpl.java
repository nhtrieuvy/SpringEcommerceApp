...
public class EmailServiceImpl implements EmailService {
    ...
    private String buildOrderConfirmationEmailHtml(Order order) {
        ...
        html.append("<!DOCTYPE html>")
            ...
            .append("<p><strong>Ngày đặt hàng:</strong> ").append(dateFormat.format(order.getOrderDate())).append("</p>")
        ...
        if (order.getPayment() != null) {
            html.append("<div class='order-info'>")
                ...
                .append("<p><strong>Phương thức:</strong> ").append(getPaymentMethodText(order.getPayment().getPaymentMethod().toString())).append("</p>")
                .append("<p><strong>Trạng thái thanh toán:</strong> ").append(getPaymentStatusText(order.getPayment().getStatus())).append("</p>")
                .append("</div>");
        }

        html.append("<p>Bạn có thể theo dõi đơn hàng tại: <a href='").append(appUrl).append("/orders'>").append(appUrl).append("/orders</a></p>")
    ...
    private String buildOrderStatusUpdateEmailHtml(Order order, String oldStatus, String newStatus) {
        ...
        html.append("<!DOCTYPE html>")
            ...
            .append("<p><strong>Thời gian:</strong> ").append(dateFormat.format(new java.util.Date())).append("</p>")
            .append("</div>")
            .append("<p>Bạn có thể theo dõi đơn hàng tại: <a href='").append(appUrl).append("/orders'>").append(appUrl).append("/orders</a></p>")
