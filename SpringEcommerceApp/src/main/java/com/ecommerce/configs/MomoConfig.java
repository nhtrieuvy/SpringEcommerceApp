...
public class MomoConfig {
    ...
    @Value("${momo.returnUrl:https://localhost:3000/checkout/momo/return}")
    private String returnUrl;

    @Value("${momo.notifyUrl:https://localhost:8443/api/payments/momo/notify}")
    ...
    // If the MoMo SDK requires an initialized client object (like PayPal's APIContext),
